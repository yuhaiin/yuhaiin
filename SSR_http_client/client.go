...
func (bi *BackendInfo) Listen() {
	...
	for {
		...
		go bi.HandleClientRequest(localConn)
	}
}
/*
...
*/
func (bi *BackendInfo) HandleClientRequest(client net.Conn){
	fmt.Println("connect")
	if client == nil{
		return
	}
	...
	fmt.Println(host,method)

/*
	if hostPortURL.Opaque == "433" {
