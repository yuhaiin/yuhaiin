...
func (c *nodeManagerClient) Now(ctx context.Context, in *node.NowReq, opts ...grpc.CallOption) (*node.Point, error) {
	out := new(node.Point)
...
func (c *nodeManagerClient) Use(ctx context.Context, in *node.UseReq, opts ...grpc.CallOption) (*node.Point, error) {
	out := new(node.Point)
...
func (UnimplementedNodeManagerServer) Now(context.Context, *node.NowReq) (*node.Point, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Now not implemented")
}
func (UnimplementedNodeManagerServer) Use(context.Context, *node.UseReq) (*node.Point, error) {
...
func _NodeManager_Now_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeManagerServer).Now(ctx, req.(*node.NowReq))
	}
...
func _NodeManager_Use_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeManagerServer).Use(ctx, req.(*node.UseReq))
	}
	return interceptor(ctx, in, info, handler)
}
