...
type BypassConfig struct {
	...
	xxx_hidden_RefreshConfig  *RefreshConfig         `protobuf:"bytes,17,opt,name=refresh_config"`
	XXX_raceDetectHookData    protoimpl.RaceDetectHookData
	XXX_presence              [1]uint32
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
...
func (x *BypassConfig) HasRefreshConfig() bool {
	if x == nil {
		return false
	}
...
type RefreshConfig struct {
	...
	xxx_hidden_LastRefreshTime uint64                 `protobuf:"varint,2,opt,name=last_refresh_time"`
...
func (*RefreshConfig) ProtoMessage() {}

func (x *RefreshConfig) ProtoReflect() protoreflect.Message {
	mi := &file_config_bypass_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *RefreshConfig) HasRefreshInterval() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *RefreshConfig) HasLastRefreshTime() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
func (x *RefreshConfig) HasError() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 2)
...
func (x *RefreshConfig) ClearLastRefreshTime() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_LastRefreshTime = 0
}
...
func (b0 RefreshConfig_builder) Build() *RefreshConfig {
	m0 := &RefreshConfig{}
	b, x := &b0, m0
	_, _ = b, x
...
func (x case_RemoteRule_Object) String() string {
	md := file_config_bypass_proto_msgTypes[5].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (x case_Rule_Object) String() string {
	md := file_config_bypass_proto_msgTypes[13].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
type Rulev2 struct {
	...
	xxx_hidden_Disabled             bool                   `protobuf:"varint,8,opt,name=disabled"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
func (x *Rulev2) HasDisabled() bool {
	if x == nil {
		return false
	}
...
func (x case_List_List) String() string {
	md := file_config_bypass_proto_msgTypes[17].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (x *ListRemote) Reset() {
	*x = ListRemote{}
	mi := &file_config_bypass_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_config_bypass_proto_rawDesc = "" +
	...
	"\x05error\x18\x02 \x01(\tR\x05error\"\xb3\x04\n" +
	"\rbypass_config\x12O\n" +
	...
	"\x05lists\x18\r \x03(\v2(.yuhaiin.bypass.bypass_config.ListsEntryR\x05lists\x12I\n" +
	"\x0fmaxminddb_geoip\x18\x10 \x01(\v2\x1f.yuhaiin.bypass.maxminddb_geoipR\x0fmaxminddb_geoip\x12F\n" +
	"\x0erefresh_config\x18\x11 \x01(\v2\x1e.yuhaiin.bypass.refresh_configR\x0erefresh_config\x1aN\n" +
	"\n" +
	"ListsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.yuhaiin.bypass.listR\x05value:\x028\x01\"\x80\x01\n" +
	"\x0erefresh_config\x12*\n" +
	"\x10refresh_interval\x18\x01 \x01(\x04R\x10refresh_interval\x12,\n" +
	"\x11last_refresh_time\x18\x02 \x01(\x04R\x11last_refresh_time\x12\x14\n" +
	...
	"\x03udp\x10\x02\"0\n" +
	"\x02or\x12*\n" +
	"\x05rules\x18\x01 \x03(\v2\x14.yuhaiin.bypass.ruleR\x05rules\"\xeb\x02\n" +
	"\x06rulev2\x12\x12\n" +
	...
	"\x05rules\x18\a \x03(\v2\x12.yuhaiin.bypass.orR\x05rules\x12\x1a\n" +
	"\bdisabled\x18\b \x01(\bR\bdisabled\"\xa7\x02\n" +
	"\x04list\x12<\n" +
...
var file_config_bypass_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_config_bypass_proto_goTypes = []any{
	...
	(*RefreshConfig)(nil),     // 8: yuhaiin.bypass.refresh_config
	(*ModeConfig)(nil),        // 9: yuhaiin.bypass.mode_config
	(*RemoteRule)(nil),        // 10: yuhaiin.bypass.remote_rule
	(*RemoteRuleFile)(nil),    // 11: yuhaiin.bypass.remote_rule_file
	(*RemoteRuleHttp)(nil),    // 12: yuhaiin.bypass.remote_rule_http
	(*Host)(nil),              // 13: yuhaiin.bypass.host
	(*Process)(nil),           // 14: yuhaiin.bypass.process
	(*Source)(nil),            // 15: yuhaiin.bypass.source
	(*Port)(nil),              // 16: yuhaiin.bypass.port
	(*Geoip)(nil),             // 17: yuhaiin.bypass.geoip
	(*Rule)(nil),              // 18: yuhaiin.bypass.rule
	(*Network)(nil),           // 19: yuhaiin.bypass.network
	(*Or)(nil),                // 20: yuhaiin.bypass.or
	(*Rulev2)(nil),            // 21: yuhaiin.bypass.rulev2
	(*List)(nil),              // 22: yuhaiin.bypass.list
	(*ListLocal)(nil),         // 23: yuhaiin.bypass.list_local
	(*ListRemote)(nil),        // 24: yuhaiin.bypass.list_remote
	nil,                       // 25: yuhaiin.bypass.bypass_config.ListsEntry
	nil,                       // 26: yuhaiin.bypass.mode_config.ErrorMsgsEntry
}
var file_config_bypass_proto_depIdxs = []int32{
	...
	21, // 2: yuhaiin.bypass.bypass_config.rules_v2:type_name -> yuhaiin.bypass.rulev2
	25, // 3: yuhaiin.bypass.bypass_config.lists:type_name -> yuhaiin.bypass.bypass_config.ListsEntry
	6,  // 4: yuhaiin.bypass.bypass_config.maxminddb_geoip:type_name -> yuhaiin.bypass.maxminddb_geoip
	8,  // 5: yuhaiin.bypass.bypass_config.refresh_config:type_name -> yuhaiin.bypass.refresh_config
	0,  // 6: yuhaiin.bypass.mode_config.mode:type_name -> yuhaiin.bypass.mode
	1,  // 7: yuhaiin.bypass.mode_config.resolve_strategy:type_name -> yuhaiin.bypass.resolve_strategy
	2,  // 8: yuhaiin.bypass.mode_config.udp_proxy_fqdn_strategy:type_name -> yuhaiin.bypass.udp_proxy_fqdn_strategy
	26, // 9: yuhaiin.bypass.mode_config.error_msgs:type_name -> yuhaiin.bypass.mode_config.ErrorMsgsEntry
	11, // 10: yuhaiin.bypass.remote_rule.file:type_name -> yuhaiin.bypass.remote_rule_file
	12, // 11: yuhaiin.bypass.remote_rule.http:type_name -> yuhaiin.bypass.remote_rule_http
	9,  // 12: yuhaiin.bypass.remote_rule.default_mode:type_name -> yuhaiin.bypass.mode_config
	13, // 13: yuhaiin.bypass.rule.host:type_name -> yuhaiin.bypass.host
	14, // 14: yuhaiin.bypass.rule.process:type_name -> yuhaiin.bypass.process
	15, // 15: yuhaiin.bypass.rule.inbound:type_name -> yuhaiin.bypass.source
	19, // 16: yuhaiin.bypass.rule.network:type_name -> yuhaiin.bypass.network
	16, // 17: yuhaiin.bypass.rule.port:type_name -> yuhaiin.bypass.port
	17, // 18: yuhaiin.bypass.rule.geoip:type_name -> yuhaiin.bypass.geoip
	3,  // 19: yuhaiin.bypass.network.network:type_name -> yuhaiin.bypass.network.network_type
	18, // 20: yuhaiin.bypass.or.rules:type_name -> yuhaiin.bypass.rule
	0,  // 21: yuhaiin.bypass.rulev2.mode:type_name -> yuhaiin.bypass.mode
	1,  // 22: yuhaiin.bypass.rulev2.resolve_strategy:type_name -> yuhaiin.bypass.resolve_strategy
	2,  // 23: yuhaiin.bypass.rulev2.udp_proxy_fqdn_strategy:type_name -> yuhaiin.bypass.udp_proxy_fqdn_strategy
	20, // 24: yuhaiin.bypass.rulev2.rules:type_name -> yuhaiin.bypass.or
	4,  // 25: yuhaiin.bypass.list.list_type:type_name -> yuhaiin.bypass.list.list_type_enum
	23, // 26: yuhaiin.bypass.list.local:type_name -> yuhaiin.bypass.list_local
	24, // 27: yuhaiin.bypass.list.remote:type_name -> yuhaiin.bypass.list_remote
	22, // 28: yuhaiin.bypass.bypass_config.ListsEntry.value:type_name -> yuhaiin.bypass.list
...
func file_config_bypass_proto_init() {
	...
	file_config_bypass_proto_msgTypes[5].OneofWrappers = []any{
		(*remoteRule_File)(nil),
		(*remoteRule_Http)(nil),
	}
	file_config_bypass_proto_msgTypes[13].OneofWrappers = []any{
		(*rule_Host)(nil),
		(*rule_Process)(nil),
		(*rule_Inbound)(nil),
		(*rule_Network)(nil),
	...
	file_config_bypass_proto_msgTypes[17].OneofWrappers = []any{
		(*list_Local)(nil),
		(*list_Remote)(nil),
	}
	type x struct{}
