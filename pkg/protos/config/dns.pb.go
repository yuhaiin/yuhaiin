...
func (Type) Descriptor() protoreflect.EnumDescriptor {
	return file_config_dns_proto_enumTypes[0].Descriptor()
}

func (Type) Type() protoreflect.EnumType {
	return &file_config_dns_proto_enumTypes[0]
}
...
func (x *Dns) Reset() {
	*x = Dns{}
	mi := &file_config_dns_proto_msgTypes[0]
...
func (x *DnsConfig) Reset() {
	*x = DnsConfig{}
	mi := &file_config_dns_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *FakednsConfig) Reset() {
	*x = FakednsConfig{}
	mi := &file_config_dns_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Server) Reset() {
	*x = Server{}
	mi := &file_config_dns_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DnsConfigV2) Reset() {
	*x = DnsConfigV2{}
	mi := &file_config_dns_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_config_dns_proto protoreflect.FileDescriptor

const file_config_dns_proto_rawDesc = "" +
	"\n" +
	"\x10config/dns.proto\x12\vyuhaiin.dns\x1a!google/protobuf/go_features.proto\"\x80\x01\n" +
	"\x03dns\x12\x12\n" +
	...
	"\x04doh3\x10\x06B8Z.github.com/Asutorufa/yuhaiin/pkg/protos/config\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_config_dns_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_config_dns_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_config_dns_proto_goTypes = []any{
...
var file_config_dns_proto_depIdxs = []int32{
...
func init() { file_config_dns_proto_init() }
func file_config_dns_proto_init() {
	if File_config_dns_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_dns_proto_rawDesc), len(file_config_dns_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_dns_proto_goTypes,
		DependencyIndexes: file_config_dns_proto_depIdxs,
		EnumInfos:         file_config_dns_proto_enumTypes,
		MessageInfos:      file_config_dns_proto_msgTypes,
	}.Build()
	File_config_dns_proto = out.File
	file_config_dns_proto_goTypes = nil
	file_config_dns_proto_depIdxs = nil
}
