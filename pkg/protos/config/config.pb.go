...
const file_config_config_proto_rawDesc = "" +
	"\n" +
	"\x13config/config.proto\x12\x0eyuhaiin.config\x1a\x14config/log/log.proto\x1a\x1aconfig/bypass/bypass.proto\x1a\x14config/dns/dns.proto\x1a\x1econfig/listener/listener.proto\x1a\x13backup/backup.proto\x1a!google/protobuf/go_features.proto\"\xa3\x05\n" +
	"\asetting\x12\x12\n" +
