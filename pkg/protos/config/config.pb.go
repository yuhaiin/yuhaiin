...
var file_config_config_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x06, 0x73, 0x6f, 0x63, 0x6b, 0x73, 0x35, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69,
...
var file_config_config_proto_goTypes = []interface{}{
	...
	(*bypass.BypassConfig)(nil),    // 2: yuhaiin.bypass.bypass_config
	(*dns.DnsConfig)(nil),          // 3: yuhaiin.dns.dns_config
	(*listener.InboundConfig)(nil), // 4: yuhaiin.listener.inbound_config
...
var file_config_config_proto_depIdxs = []int32{
	...
	2, // 1: yuhaiin.config.setting.bypass:type_name -> yuhaiin.bypass.bypass_config
	3, // 2: yuhaiin.config.setting.dns:type_name -> yuhaiin.dns.dns_config
	4, // 3: yuhaiin.config.setting.server:type_name -> yuhaiin.listener.inbound_config
