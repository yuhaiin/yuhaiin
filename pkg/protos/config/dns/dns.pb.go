...
const file_config_dns_dns_proto_rawDesc = "" +
	...
	"\x0etls_servername\x18\x02 \x01(\tR\x0etls_servername\"\x96\x04\n" +
	"\n" +
	"dns_config\x12\x16\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x10.yuhaiin.dns.dnsR\x05value:\x028\x01J\x04\b\a\x10\bJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\x14resolve_remote_domaiR\x05localR\x06remoteR\tbootstrap\"\x88\x01\n" +
	...
	"ipv6_range\x12\x1c\n" +
	"\twhitelist\x18\x04 \x03(\tR\twhitelist\"\x1c\n" +
	"\x06server\x12\x12\n" +
