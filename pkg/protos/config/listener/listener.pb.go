...
type InboundConfig struct {
	...
	Inbounds        map[string]*Inbound    `protobuf:"bytes,1,rep,name=inbounds,proto3" json:"inbounds,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *Inbound) GetNetwork() isInbound_Network {
	if x != nil {
		return x.Network
	}
	return nil
...
func (x *Inbound) GetEmpty() *Empty {
	if x != nil {
		if x, ok := x.Network.(*Inbound_Empty); ok {
			return x.Empty
		}
	}
	return nil
...
func (x *Inbound) GetTcpudp() *Tcpudp {
	if x != nil {
		if x, ok := x.Network.(*Inbound_Tcpudp); ok {
			return x.Tcpudp
		}
	}
	return nil
...
func (x *Inbound) GetQuic() *Quic {
	if x != nil {
		if x, ok := x.Network.(*Inbound_Quic); ok {
			return x.Quic
		}
	}
	return nil
...
func (x *Inbound) GetProtocol() isInbound_Protocol {
	if x != nil {
		return x.Protocol
	}
	return nil
...
func (x *Inbound) GetHttp() *Http {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Http); ok {
			return x.Http
		}
	}
	return nil
...
func (x *Inbound) GetSocks5() *Socks5 {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Socks5); ok {
			return x.Socks5
		}
	}
	return nil
...
func (x *Inbound) GetYuubinsya() *Yuubinsya {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Yuubinsya); ok {
			return x.Yuubinsya
		}
	}
	return nil
...
func (x *Inbound) GetMix() *Mixed {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Mix); ok {
			return x.Mix
		}
	}
	return nil
...
func (x *Inbound) GetSocks4A() *Socks4A {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Socks4A); ok {
			return x.Socks4A
		}
	}
	return nil
...
func (x *Inbound) GetTproxy() *Tproxy {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Tproxy); ok {
			return x.Tproxy
		}
	}
	return nil
...
func (x *Inbound) GetRedir() *Redir {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Redir); ok {
			return x.Redir
		}
	}
	return nil
...
func (x *Inbound) GetTun() *Tun {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_Tun); ok {
			return x.Tun
		}
	}
	return nil
...
func (x *Inbound) GetReverseHttp() *ReverseHttp {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_ReverseHttp); ok {
...
func (x *Inbound) GetReverseTcp() *ReverseTcp {
	if x != nil {
		if x, ok := x.Protocol.(*Inbound_ReverseTcp); ok {
			return x.ReverseTcp
		}
	}
	return nil
...
func (x *Transport) GetNormal() *Normal {
	if x != nil {
		if x, ok := x.Transport.(*Transport_Normal); ok {
			return x.Normal
		}
	}
	return nil
...
func (x *Transport) GetTls() *Tls {
	if x != nil {
		if x, ok := x.Transport.(*Transport_Tls); ok {
			return x.Tls
		}
	}
	return nil
...
func (x *Transport) GetMux() *Mux {
	if x != nil {
		if x, ok := x.Transport.(*Transport_Mux); ok {
			return x.Mux
		}
	}
	return nil
...
func (x *Transport) GetHttp2() *Http2 {
	if x != nil {
		if x, ok := x.Transport.(*Transport_Http2); ok {
			return x.Http2
		}
	}
	return nil
...
func (x *Transport) GetWebsocket() *Websocket {
	if x != nil {
		if x, ok := x.Transport.(*Transport_Websocket); ok {
			return x.Websocket
		}
	}
	return nil
...
func (x *Transport) GetReality() *Reality {
	if x != nil {
		if x, ok := x.Transport.(*Transport_Reality); ok {
			return x.Reality
		}
	}
	return nil
...
type TlsConfig struct {
	...
	ServerNameCertificate map[string]*Certificate `protobuf:"bytes,4,rep,name=server_name_certificate,proto3" json:"server_name_certificate,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
