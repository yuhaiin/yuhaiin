...
var file_config_listener_listener_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6d, 0x5f, 0x67, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x10, 0x02, 0x22, 0xb9, 0x03, 0x0a,
	...
	0x48, 0x00, 0x52, 0x05, 0x68, 0x74, 0x74, 0x70, 0x32, 0x1a, 0x11, 0x0a, 0x0f, 0x70, 0x72, 0x6f,
	...
	0x61, 0x6c, 0x22, 0x3b, 0x0a, 0x09, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x12,
	...
	0x67, 0x52, 0x03, 0x74, 0x6c, 0x73, 0x22, 0x37, 0x0a, 0x05, 0x68, 0x74, 0x74, 0x70, 0x32, 0x12,
	0x2e, 0x0a, 0x03, 0x74, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x79,
	0x75, 0x68, 0x61, 0x69, 0x69, 0x6e, 0x2e, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x2e,
	0x74, 0x6c, 0x73, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03, 0x74, 0x6c, 0x73, 0x22,
	...
	0x61, 0x74, 0x68, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_config_listener_listener_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_config_listener_listener_proto_goTypes = []interface{}{
	...
	(*TlsConfig)(nil),               // 14: yuhaiin.listener.tls_config
	(*Certificate)(nil),             // 15: yuhaiin.listener.certificate
	nil,                             // 16: yuhaiin.listener.config.ServersEntry
	(*YuubinsyaProtocolNormal)(nil), // 17: yuhaiin.listener.yuubinsya.protocol_normal
	nil,                             // 18: yuhaiin.listener.tls_config.ServerNameCertificateEntry
}
var file_config_listener_listener_proto_depIdxs = []int32{
	...
	16, // 5: yuhaiin.listener.config.servers:type_name -> yuhaiin.listener.config.ServersEntry
	...
	14, // 13: yuhaiin.listener.websocket.tls:type_name -> yuhaiin.listener.tls_config
	14, // 14: yuhaiin.listener.quic.tls:type_name -> yuhaiin.listener.tls_config
	14, // 15: yuhaiin.listener.tls.tls:type_name -> yuhaiin.listener.tls_config
	14, // 16: yuhaiin.listener.grpc.tls:type_name -> yuhaiin.listener.tls_config
	14, // 17: yuhaiin.listener.http2.tls:type_name -> yuhaiin.listener.tls_config
	15, // 18: yuhaiin.listener.tls_config.certificates:type_name -> yuhaiin.listener.certificate
	18, // 19: yuhaiin.listener.tls_config.server_name_certificate:type_name -> yuhaiin.listener.tls_config.ServerNameCertificateEntry
	1,  // 20: yuhaiin.listener.config.ServersEntry.value:type_name -> yuhaiin.listener.protocol
	15, // 21: yuhaiin.listener.tls_config.ServerNameCertificateEntry.value:type_name -> yuhaiin.listener.certificate
