...
func (x case_Rule_Object) String() string {
	md := file_config_bypass_bypass_proto_msgTypes[8].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
const file_config_bypass_bypass_proto_rawDesc = "" +
	"\n" +
	"\x1aconfig/bypass/bypass.proto\x12\x0eyuhaiin.bypass\x1a!google/protobuf/go_features.proto\"\xb6\x05\n" +
	"\x06config\x12&\n" +
	...
	"\x0eproxy_resolver\x18\v \x01(\tR\x0eproxy_resolver\x12\x1e\n" +
	"\n" +
	"enabled_v2\x18\x0e \x01(\bR\n" +
	"enabled_v2\x122\n" +
...
func file_config_bypass_bypass_proto_init() {
	...
	file_config_bypass_bypass_proto_msgTypes[8].OneofWrappers = []any{
		(*rule_Host)(nil),
		(*rule_Process)(nil),
		(*rule_Inbound)(nil),
	}
