...
const file_config_grpc_config_proto_rawDesc = "" +
	...
	"\x05sniff\x18\x04 \x01(\v2\x17.yuhaiin.listener.sniffR\x05sniff\"$\n" +
	...
	"\x0fchange_priority\x126.yuhaiin.protos.config.service.change_priority_request\x1a\x16.google.protobuf.Empty2\xec\x02\n" +
	"\ainbound\x12P\n" +
	...
	"\x05apply\x120.yuhaiin.protos.config.service.inbounds_response\x1a\x16.google.protobuf.Empty2\xb3\x05\n" +
	"\bresolver\x12K\n" +
...
var file_config_grpc_config_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_config_grpc_config_proto_goTypes = []any{
	...
	(*ResolveList)(nil),            // 9: yuhaiin.protos.config.service.resolve_list
	(*SaveResolver)(nil),           // 10: yuhaiin.protos.config.service.save_resolver
	(*Hosts)(nil),                  // 11: yuhaiin.protos.config.service.Hosts
	nil,                            // 12: yuhaiin.protos.config.service.Hosts.HostsEntry
	(*bypass.ModeConfig)(nil),      // 13: yuhaiin.bypass.mode_config
	(*timestamppb.Timestamp)(nil),  // 14: google.protobuf.Timestamp
	(*bypass.Rulev2)(nil),          // 15: yuhaiin.bypass.rulev2
	(*listener.Sniff)(nil),         // 16: yuhaiin.listener.sniff
	(*dns.Dns)(nil),                // 17: yuhaiin.dns.dns
	(*emptypb.Empty)(nil),          // 18: google.protobuf.Empty
	(*config.Setting)(nil),         // 19: yuhaiin.config.setting
	(*bypass.Config)(nil),          // 20: yuhaiin.bypass.config
	(*wrapperspb.StringValue)(nil), // 21: google.protobuf.StringValue
	(*bypass.List)(nil),            // 22: yuhaiin.bypass.list
	(*listener.Inbound)(nil),       // 23: yuhaiin.listener.inbound
	(*dns.FakednsConfig)(nil),      // 24: yuhaiin.dns.fakedns_config
	(*config.Info)(nil),            // 25: yuhaiin.config.info
}
var file_config_grpc_config_proto_depIdxs = []int32{
	13, // 0: yuhaiin.protos.config.service.test_response.mode:type_name -> yuhaiin.bypass.mode_config
	14, // 1: yuhaiin.protos.config.service.block_history.time:type_name -> google.protobuf.Timestamp
	...
	15, // 4: yuhaiin.protos.config.service.rule_save_request.rule:type_name -> yuhaiin.bypass.rulev2
	...
	16, // 7: yuhaiin.protos.config.service.inbounds_response.sniff:type_name -> yuhaiin.listener.sniff
	17, // 8: yuhaiin.protos.config.service.save_resolver.resolver:type_name -> yuhaiin.dns.dns
	12, // 9: yuhaiin.protos.config.service.Hosts.hosts:type_name -> yuhaiin.protos.config.service.Hosts.HostsEntry
	18, // 10: yuhaiin.protos.config.service.config_service.load:input_type -> google.protobuf.Empty
	19, // 11: yuhaiin.protos.config.service.config_service.save:input_type -> yuhaiin.config.setting
	18, // 12: yuhaiin.protos.config.service.config_service.info:input_type -> google.protobuf.Empty
	18, // 13: yuhaiin.protos.config.service.bypass.load:input_type -> google.protobuf.Empty
	20, // 14: yuhaiin.protos.config.service.bypass.save:input_type -> yuhaiin.bypass.config
	18, // 15: yuhaiin.protos.config.service.bypass.reload:input_type -> google.protobuf.Empty
	21, // 16: yuhaiin.protos.config.service.bypass.test:input_type -> google.protobuf.StringValue
	18, // 17: yuhaiin.protos.config.service.bypass.block_history:input_type -> google.protobuf.Empty
	18, // 18: yuhaiin.protos.config.service.lists.list:input_type -> google.protobuf.Empty
	21, // 19: yuhaiin.protos.config.service.lists.get:input_type -> google.protobuf.StringValue
	22, // 20: yuhaiin.protos.config.service.lists.save:input_type -> yuhaiin.bypass.list
	21, // 21: yuhaiin.protos.config.service.lists.remove:input_type -> google.protobuf.StringValue
	18, // 22: yuhaiin.protos.config.service.lists.refresh:input_type -> google.protobuf.Empty
	18, // 23: yuhaiin.protos.config.service.rules.list:input_type -> google.protobuf.Empty
	5,  // 24: yuhaiin.protos.config.service.rules.get:input_type -> yuhaiin.protos.config.service.rule_index
	6,  // 25: yuhaiin.protos.config.service.rules.save:input_type -> yuhaiin.protos.config.service.rule_save_request
	5,  // 26: yuhaiin.protos.config.service.rules.remove:input_type -> yuhaiin.protos.config.service.rule_index
	7,  // 27: yuhaiin.protos.config.service.rules.change_priority:input_type -> yuhaiin.protos.config.service.change_priority_request
	18, // 28: yuhaiin.protos.config.service.inbound.list:input_type -> google.protobuf.Empty
	21, // 29: yuhaiin.protos.config.service.inbound.get:input_type -> google.protobuf.StringValue
	23, // 30: yuhaiin.protos.config.service.inbound.save:input_type -> yuhaiin.listener.inbound
	21, // 31: yuhaiin.protos.config.service.inbound.remove:input_type -> google.protobuf.StringValue
	8,  // 32: yuhaiin.protos.config.service.inbound.apply:input_type -> yuhaiin.protos.config.service.inbounds_response
	18, // 33: yuhaiin.protos.config.service.resolver.list:input_type -> google.protobuf.Empty
	21, // 34: yuhaiin.protos.config.service.resolver.get:input_type -> google.protobuf.StringValue
	10, // 35: yuhaiin.protos.config.service.resolver.save:input_type -> yuhaiin.protos.config.service.save_resolver
	21, // 36: yuhaiin.protos.config.service.resolver.remove:input_type -> google.protobuf.StringValue
	18, // 37: yuhaiin.protos.config.service.resolver.hosts:input_type -> google.protobuf.Empty
	11, // 38: yuhaiin.protos.config.service.resolver.save_hosts:input_type -> yuhaiin.protos.config.service.Hosts
	18, // 39: yuhaiin.protos.config.service.resolver.fakedns:input_type -> google.protobuf.Empty
	24, // 40: yuhaiin.protos.config.service.resolver.save_fakedns:input_type -> yuhaiin.dns.fakedns_config
	18, // 41: yuhaiin.protos.config.service.resolver.server:input_type -> google.protobuf.Empty
	21, // 42: yuhaiin.protos.config.service.resolver.save_server:input_type -> google.protobuf.StringValue
	19, // 43: yuhaiin.protos.config.service.config_service.load:output_type -> yuhaiin.config.setting
	18, // 44: yuhaiin.protos.config.service.config_service.save:output_type -> google.protobuf.Empty
	25, // 45: yuhaiin.protos.config.service.config_service.info:output_type -> yuhaiin.config.info
	20, // 46: yuhaiin.protos.config.service.bypass.load:output_type -> yuhaiin.bypass.config
	18, // 47: yuhaiin.protos.config.service.bypass.save:output_type -> google.protobuf.Empty
	18, // 48: yuhaiin.protos.config.service.bypass.reload:output_type -> google.protobuf.Empty
	0,  // 49: yuhaiin.protos.config.service.bypass.test:output_type -> yuhaiin.protos.config.service.test_response
	2,  // 50: yuhaiin.protos.config.service.bypass.block_history:output_type -> yuhaiin.protos.config.service.block_history_list
	3,  // 51: yuhaiin.protos.config.service.lists.list:output_type -> yuhaiin.protos.config.service.list_response
	22, // 52: yuhaiin.protos.config.service.lists.get:output_type -> yuhaiin.bypass.list
	18, // 53: yuhaiin.protos.config.service.lists.save:output_type -> google.protobuf.Empty
	18, // 54: yuhaiin.protos.config.service.lists.remove:output_type -> google.protobuf.Empty
	18, // 55: yuhaiin.protos.config.service.lists.refresh:output_type -> google.protobuf.Empty
	4,  // 56: yuhaiin.protos.config.service.rules.list:output_type -> yuhaiin.protos.config.service.rule_response
	15, // 57: yuhaiin.protos.config.service.rules.get:output_type -> yuhaiin.bypass.rulev2
	18, // 58: yuhaiin.protos.config.service.rules.save:output_type -> google.protobuf.Empty
	18, // 59: yuhaiin.protos.config.service.rules.remove:output_type -> google.protobuf.Empty
	18, // 60: yuhaiin.protos.config.service.rules.change_priority:output_type -> google.protobuf.Empty
	8,  // 61: yuhaiin.protos.config.service.inbound.list:output_type -> yuhaiin.protos.config.service.inbounds_response
	23, // 62: yuhaiin.protos.config.service.inbound.get:output_type -> yuhaiin.listener.inbound
	23, // 63: yuhaiin.protos.config.service.inbound.save:output_type -> yuhaiin.listener.inbound
	18, // 64: yuhaiin.protos.config.service.inbound.remove:output_type -> google.protobuf.Empty
	18, // 65: yuhaiin.protos.config.service.inbound.apply:output_type -> google.protobuf.Empty
	9,  // 66: yuhaiin.protos.config.service.resolver.list:output_type -> yuhaiin.protos.config.service.resolve_list
	17, // 67: yuhaiin.protos.config.service.resolver.get:output_type -> yuhaiin.dns.dns
	17, // 68: yuhaiin.protos.config.service.resolver.save:output_type -> yuhaiin.dns.dns
	18, // 69: yuhaiin.protos.config.service.resolver.remove:output_type -> google.protobuf.Empty
	11, // 70: yuhaiin.protos.config.service.resolver.hosts:output_type -> yuhaiin.protos.config.service.Hosts
	18, // 71: yuhaiin.protos.config.service.resolver.save_hosts:output_type -> google.protobuf.Empty
	24, // 72: yuhaiin.protos.config.service.resolver.fakedns:output_type -> yuhaiin.dns.fakedns_config
	18, // 73: yuhaiin.protos.config.service.resolver.save_fakedns:output_type -> google.protobuf.Empty
	21, // 74: yuhaiin.protos.config.service.resolver.server:output_type -> google.protobuf.StringValue
	18, // 75: yuhaiin.protos.config.service.resolver.save_server:output_type -> google.protobuf.Empty
