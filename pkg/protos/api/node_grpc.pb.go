...
const (
	...
	Tag_ListPage_FullMethodName = "/yuhaiin.api.node.tag/list_page"
)
...
type TagClient interface {
	...
	ListPage(ctx context.Context, in *TagPageRequest, opts ...grpc.CallOption) (*TagsResponse, error)
}
...
func (c *tagClient) ListPage(ctx context.Context, in *TagPageRequest, opts ...grpc.CallOption) (*TagsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TagsResponse)
	err := c.cc.Invoke(ctx, Tag_ListPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TagServer interface {
	...
	ListPage(context.Context, *TagPageRequest) (*TagsResponse, error)
...
func (UnimplementedTagServer) ListPage(context.Context, *TagPageRequest) (*TagsResponse, error) {
...
func _Tag_ListPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TagPageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagServer).ListPage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tag_ListPage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServer).ListPage(ctx, req.(*TagPageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
