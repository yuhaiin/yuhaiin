...
const (
	...
	Lists_RefreshInterval_FullMethodName     = "/yuhaiin.api.config.lists/refresh_interval"
	Lists_SaveRefreshInterval_FullMethodName = "/yuhaiin.api.config.lists/save_refresh_interval"
	Lists_SaveMaxminddbGeoip_FullMethodName  = "/yuhaiin.api.config.lists/save_maxminddb_geoip"
)
...
type ListsClient interface {
	...
	SaveMaxminddbGeoip(ctx context.Context, in *config.MaxminddbGeoip, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *listsClient) SaveMaxminddbGeoip(ctx context.Context, in *config.MaxminddbGeoip, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Lists_SaveMaxminddbGeoip_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ListsServer interface {
	...
	SaveMaxminddbGeoip(context.Context, *config.MaxminddbGeoip) (*emptypb.Empty, error)
...
func (UnimplementedListsServer) SaveMaxminddbGeoip(context.Context, *config.MaxminddbGeoip) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveMaxminddbGeoip not implemented")
}
...
func _Lists_SaveMaxminddbGeoip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(config.MaxminddbGeoip)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListsServer).SaveMaxminddbGeoip(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Lists_SaveMaxminddbGeoip_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListsServer).SaveMaxminddbGeoip(ctx, req.(*config.MaxminddbGeoip))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Lists_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "save_maxminddb_geoip",
			Handler:    _Lists_SaveMaxminddbGeoip_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/config.proto",
