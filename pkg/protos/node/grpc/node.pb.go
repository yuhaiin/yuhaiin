...
type NodesResponse struct {
	...
	Groups map[string]*node.Nodes `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type TagsResponse struct {
	...
	Tags map[string]*tag.Tags `protobuf:"bytes,1,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func file_node_grpc_node_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_node_grpc_node_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_node_grpc_node_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*UseReq); i {
			case 0:
				return &v.state
			case 1:
		...
		file_node_grpc_node_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_node_grpc_node_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_node_grpc_node_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_node_grpc_node_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_node_grpc_node_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_node_grpc_node_proto_msgTypes[7].Exporter = func(v any, i int) any {
