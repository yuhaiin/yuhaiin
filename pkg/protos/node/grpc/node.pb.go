...
const file_node_grpc_node_proto_rawDesc = "" +
	...
	"\x04hash\x18\x03 \x01(\tR\x04hash\"\xb1\x01\n" +
	"\x0enodes_response\x12O\n" +
	"\x06groups\x18\x01 \x03(\v27.yuhaiin.protos.node.service.nodes_response.GroupsEntryR\x06groups\x1aN\n" +
	"\vGroupsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.yuhaiin.node.nodesR\x05value:\x028\x01\"@\n" +
