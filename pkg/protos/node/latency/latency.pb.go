...
func (x *Protocol) GetProtocol() isProtocol_Protocol {
	if x != nil {
		return x.Protocol
	}
	return nil
...
func (x *Protocol) GetHttp() *Http {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Http); ok {
			return x.Http
		}
	}
	return nil
...
func (x *Protocol) GetDns() *Dns {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Dns); ok {
			return x.Dns
		}
	}
	return nil
...
func (x *Protocol) GetDnsOverQuic() *DnsOverQuic {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_DnsOverQuic); ok {
...
func (x *Protocol) GetIp() *Ip {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Ip); ok {
			return x.Ip
		}
	}
	return nil
...
func (x *Protocol) GetStun() *Stun {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Stun); ok {
			return x.Stun
		}
	}
	return nil
...
type Response struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IdLatencyMap  map[string]*Reply      `protobuf:"bytes,1,rep,name=id_latency_map,proto3" json:"id_latency_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Reply) GetReply() isReply_Reply {
	if x != nil {
		return x.Reply
	}
	return nil
...
func (x *Reply) GetLatency() *durationpb.Duration {
	if x != nil {
		if x, ok := x.Reply.(*Reply_Latency); ok {
			return x.Latency
		}
	}
	return nil
...
func (x *Reply) GetError() *Error {
	if x != nil {
		if x, ok := x.Reply.(*Reply_Error); ok {
			return x.Error
		}
	}
	return nil
