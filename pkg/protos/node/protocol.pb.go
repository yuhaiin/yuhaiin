...
const file_node_protocol_proto_rawDesc = "" +
	"\n" +
	"\x13node/protocol.proto\x12\x10yuhaiin.protocol\x1a!google/protobuf/go_features.proto\"\xe8\x0e\n" +
	"\bprotocol\x12E\n" +
	...
	"\rnetwork_split\x18\x1f \x01(\v2\x1f.yuhaiin.protocol.network_splitB\x02(\x01H\x00R\rnetwork_splitB\n" +
	"\n" +
	"\bprotocol\"z\n" +
	"\x06socks5\x12\x1a\n" +
...
var file_node_protocol_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
