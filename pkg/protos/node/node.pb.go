...
const file_node_node_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x17.yuhaiin.subscribe.linkR\x05value:\x028\x01\"\x85\x01\n" +
	"\x05nodes\x12@\n" +
	"\anodesV2\x18\x03 \x03(\v2 .yuhaiin.node.nodes.NodesV2EntryR\rnode_hash_map\x1a:\n" +
	"\fNodesV2Entry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xac\x03\n" +
	"\amanager\x12F\n" +
	"\bgroupsV2\x18\x02 \x03(\v2#.yuhaiin.node.manager.GroupsV2EntryR\x0fgroup_nodes_map\x126\n" +
	"\x05nodes\x18\x03 \x03(\v2 .yuhaiin.node.manager.NodesEntryR\x05nodes\x123\n" +
	"\x04tags\x18\x04 \x03(\v2\x1f.yuhaiin.node.manager.TagsEntryR\x04tags\x1aP\n" +
	"\rGroupsV2Entry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.yuhaiin.node.nodesR\x05value:\x028\x01\x1aN\n" +
	"\n" +
	"NodesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	...
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.yuhaiin.tag.tagsR\x05value:\x028\x01B6Z,github.com/Asutorufa/yuhaiin/pkg/protos/node\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
