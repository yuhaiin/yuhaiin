...
type Node struct {
	...
	Links         map[string]*subscribe.Link `protobuf:"bytes,2,rep,name=links,proto3" json:"links,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Nodes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodesV2       map[string]string      `protobuf:"bytes,3,rep,name=nodesV2,json=node_hash_map,proto3" json:"nodesV2,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Manager struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	GroupsV2      map[string]*Nodes       `protobuf:"bytes,2,rep,name=groupsV2,json=group_nodes_map,proto3" json:"groupsV2,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Nodes         map[string]*point.Point `protobuf:"bytes,3,rep,name=nodes,proto3" json:"nodes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Tags          map[string]*tag.Tags    `protobuf:"bytes,4,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
