...
var file_node_node_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_node_node_proto_depIdxs = []int32{
	...
	2,  // 5: yuhaiin.node.node.tcp:type_name -> yuhaiin.node.point
	2,  // 6: yuhaiin.node.node.udp:type_name -> yuhaiin.node.point
	19, // 7: yuhaiin.node.node.links:type_name -> yuhaiin.node.node.LinksEntry
	16, // 8: yuhaiin.node.node.manager:type_name -> yuhaiin.node.manager
	21, // 9: yuhaiin.node.manager.group_nodes_map:type_name -> yuhaiin.node.manager.GroupNodesMapEntry
	22, // 10: yuhaiin.node.manager.nodes:type_name -> yuhaiin.node.manager.NodesEntry
	5,  // 11: yuhaiin.node.point.protocol.shadowsocks:type_name -> yuhaiin.node.shadowsocks
	6,  // 12: yuhaiin.node.point.protocol.shadowsocksr:type_name -> yuhaiin.node.shadowsocksr
	7,  // 13: yuhaiin.node.point.protocol.vmess:type_name -> yuhaiin.node.vmess
	9,  // 14: yuhaiin.node.point.protocol.websocket:type_name -> yuhaiin.node.websocket
	10, // 15: yuhaiin.node.point.protocol.quic:type_name -> yuhaiin.node.quic
	11, // 16: yuhaiin.node.point.protocol.obfs_http:type_name -> yuhaiin.node.obfs_http
	8,  // 17: yuhaiin.node.point.protocol.trojan:type_name -> yuhaiin.node.trojan
	13, // 18: yuhaiin.node.point.protocol.simple:type_name -> yuhaiin.node.simple
	12, // 19: yuhaiin.node.point.protocol.none:type_name -> yuhaiin.node.none
	3,  // 20: yuhaiin.node.point.protocol.socks5:type_name -> yuhaiin.node.socks5
	4,  // 21: yuhaiin.node.point.protocol.http:type_name -> yuhaiin.node.http
...
func file_node_node_proto_init() {
	...
	file_node_node_proto_msgTypes[15].OneofWrappers = []interface{}{
