...
type Manager struct {
	...
	Tags          map[string]*Tags        `protobuf:"bytes,4,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_node_node_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd6, 0x03, 0x0a, 0x07, 0x6d,
	...
	0x74, 0x72, 0x79, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x33, 0x0a, 0x04, 0x74, 0x61,
	0x67, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x79, 0x75, 0x68, 0x61, 0x69,
	...
	0x55, 0x0a, 0x12, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x4d, 0x61, 0x70,
	...
	0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4e, 0x0a, 0x0a, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4b, 0x0a, 0x09, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e,
	...
	0x6f, 0x64, 0x65, 0x2e, 0x74, 0x61, 0x67, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0x2c, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x74,
	0x61, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x12, 0x0a,
	0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73,
...
var file_node_node_proto_goTypes = []interface{}{
	...
	(*Tags)(nil),           // 3: yuhaiin.node.tags
	nil,                    // 4: yuhaiin.node.node.LinksEntry
	nil,                    // 5: yuhaiin.node.nodes.NodeHashMapEntry
	nil,                    // 6: yuhaiin.node.manager.GroupNodesMapEntry
	nil,                    // 7: yuhaiin.node.manager.NodesEntry
	nil,                    // 8: yuhaiin.node.manager.TagsEntry
	(*point.Point)(nil),    // 9: yuhaiin.point.point
	(*subscribe.Link)(nil), // 10: yuhaiin.subscribe.link
}
var file_node_node_proto_depIdxs = []int32{
	9,  // 0: yuhaiin.node.node.tcp:type_name -> yuhaiin.point.point
	9,  // 1: yuhaiin.node.node.udp:type_name -> yuhaiin.point.point
	4,  // 2: yuhaiin.node.node.links:type_name -> yuhaiin.node.node.LinksEntry
	2,  // 3: yuhaiin.node.node.manager:type_name -> yuhaiin.node.manager
	5,  // 4: yuhaiin.node.nodes.node_hash_map:type_name -> yuhaiin.node.nodes.NodeHashMapEntry
	6,  // 5: yuhaiin.node.manager.group_nodes_map:type_name -> yuhaiin.node.manager.GroupNodesMapEntry
	7,  // 6: yuhaiin.node.manager.nodes:type_name -> yuhaiin.node.manager.NodesEntry
	8,  // 7: yuhaiin.node.manager.tags:type_name -> yuhaiin.node.manager.TagsEntry
	10, // 8: yuhaiin.node.node.LinksEntry.value:type_name -> yuhaiin.subscribe.link
	1,  // 9: yuhaiin.node.manager.GroupNodesMapEntry.value:type_name -> yuhaiin.node.nodes
	9,  // 10: yuhaiin.node.manager.NodesEntry.value:type_name -> yuhaiin.point.point
	3,  // 11: yuhaiin.node.manager.TagsEntry.value:type_name -> yuhaiin.node.tags
