...
func (x *Protocol) GetShadowsocks() *Shadowsocks {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Shadowsocks); ok {
...
func (x *Protocol) GetShadowsocksr() *Shadowsocksr {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Shadowsocksr); ok {
...
func (x *Protocol) GetVmess() *Vmess {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Vmess); ok {
			return x.Vmess
		}
	}
	return nil
...
func (x *Protocol) GetWebsocket() *Websocket {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Websocket); ok {
			return x.Websocket
		}
	}
	return nil
...
func (x *Protocol) GetQuic() *Quic {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Quic); ok {
			return x.Quic
		}
	}
	return nil
...
func (x *Protocol) GetObfsHttp() *ObfsHttp {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_ObfsHttp); ok {
			return x.ObfsHttp
		}
	}
	return nil
...
func (x *Protocol) GetTrojan() *Trojan {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Trojan); ok {
			return x.Trojan
		}
	}
	return nil
...
func (x *Protocol) GetSimple() *Simple {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Simple); ok {
			return x.Simple
		}
	}
	return nil
...
func (x *Protocol) GetNone() *None {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_None); ok {
			return x.None
		}
	}
	return nil
...
func (x *Protocol) GetSocks5() *Socks5 {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Socks5); ok {
			return x.Socks5
		}
	}
	return nil
...
func (x *Protocol) GetDirect() *Direct {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Direct); ok {
			return x.Direct
		}
	}
	return nil
...
func (x *Protocol) GetReject() *Reject {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Reject); ok {
			return x.Reject
		}
	}
	return nil
...
func (x *Protocol) GetYuubinsya() *Yuubinsya {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Yuubinsya); ok {
			return x.Yuubinsya
		}
	}
	return nil
...
func (x *Protocol) GetGrpc() *Grpc {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Grpc); ok {
			return x.Grpc
		}
	}
	return nil
...
func (x *Protocol) GetHttp2() *Http2 {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Http2); ok {
			return x.Http2
		}
	}
	return nil
...
func (x *Protocol) GetReality() *Reality {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Reality); ok {
			return x.Reality
		}
	}
	return nil
...
func (x *Protocol) GetTls() *TlsConfig {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Tls); ok {
			return x.Tls
		}
	}
	return nil
...
func (x *Protocol) GetWireguard() *Wireguard {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Wireguard); ok {
			return x.Wireguard
		}
	}
	return nil
...
func (x *Protocol) GetMux() *Mux {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Mux); ok {
			return x.Mux
		}
	}
	return nil
...
func (x *Protocol) GetDrop() *Drop {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Drop); ok {
			return x.Drop
		}
	}
	return nil
...
func (x *Protocol) GetVless() *Vless {
	if x != nil {
		if x, ok := x.Protocol.(*Protocol_Vless); ok {
			return x.Vless
		}
	}
	return nil
...
type Simple struct {
	...
	NetworkInterface string                 `protobuf:"bytes,7,opt,name=network_interface,proto3" json:"network_interface,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type Direct struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	NetworkInterface string                 `protobuf:"bytes,2,opt,name=network_interface,proto3" json:"network_interface,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
var file_node_protocol_protocol_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x06, 0x0a, 0x04, 0x6e, 0x6f, 0x6e, 0x65, 0x22, 0xd2,
	...
	,
	...
	,
	...
	0x73, 0x22, 0xd6, 0x01, 0x0a, 0x09, 0x77, 0x69, 0x72, 0x65, 0x67, 0x75, 0x61, 0x72, 0x64, 0x12,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x6d, 0x74, 0x75, 0x12, 0x1a, 0x0a, 0x08, 0x72,
	0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x72,
	0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x64, 0x6c, 0x65, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x69,
	0x64, 0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x27, 0x0a, 0x03, 0x6d, 0x75,
