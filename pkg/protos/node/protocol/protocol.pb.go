...
func (x *HttpTerminationHttpHeaders) Reset() {
	*x = HttpTerminationHttpHeaders{}
	mi := &file_node_protocol_protocol_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_node_protocol_protocol_proto_rawDesc = "" +
	"\n" +
	"\x1cnode/protocol/protocol.proto\x12\x10yuhaiin.protocol\x1a!google/protobuf/go_features.proto\"\xee\r\n" +
	"\bprotocol\x12A\n" +
	...
	"\x05fixed\x18\x1e \x01(\v2\x17.yuhaiin.protocol.fixedH\x00R\x05fixed\x12G\n" +
	"\rnetwork_split\x18\x1f \x01(\v2\x1f.yuhaiin.protocol.network_splitH\x00R\rnetwork_splitB\n" +
	"\n" +
	"\bprotocol\"z\n" +
	"\x06socks5\x12\x1a\n" +
