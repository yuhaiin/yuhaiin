...
type Publish struct {
	...
	xxx_hidden_Insecure    bool                   `protobuf:"varint,6,opt,name=insecure"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *Publish) HasAddress() bool {
	if x == nil {
		return false
	}
...
func (x *Publish) HasInsecure() bool {
	if x == nil {
		return false
	}
...
type YuhaiinUrl_Remote struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Publish *Publish               `protobuf:"bytes,1,opt,name=publish"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
const file_node_subscribe_proto_rawDesc = "" +
	...
	"\x03url\x18\x03 \x01(\tR\x03url\"\x9b\x01\n" +
	"\aPublish\x12\x16\n" +
	...
	"\binsecure\x18\x06 \x01(\bR\binsecure\"\x9f\x02\n" +
	"\n" +
	"YuhaiinUrl\x12>\n" +
	...
	"\x06Remote\x124\n" +
	"\apublish\x18\x01 \x01(\v2\x1a.yuhaiin.subscribe.PublishR\apublish\x1a6\n" +
	"\x06Points\x12,\n" +
