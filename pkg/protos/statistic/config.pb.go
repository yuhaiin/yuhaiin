...
const file_statistic_config_proto_rawDesc = "" +
	...
	"\x0funderlying_type\x18\x02 \x01(\x0e2\x17.yuhaiin.statistic.typeR\x0funderlying_type\"\xec\x06\n" +
	"\n" +
	"connection\x12\x12\n" +
	...
	"\bresolver\x18\x1e \x01(\tR\bresolverJ\x04\b\x04\x10\x05J\x04\b\x17\x10\x18R\x05extraR\vmode_reason\"F\n" +
