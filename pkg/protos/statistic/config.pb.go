...
type Connection struct {
	...
	xxx_hidden_Interface     *string                `protobuf:"bytes,29,opt,name=interface"`
	...
	xxx_hidden_Mode          config.Mode            `protobuf:"varint,22,opt,name=mode,enum=yuhaiin.bypass.Mode"`
	xxx_hidden_MatchHistory  *[]*MatchHistoryEntry  `protobuf:"bytes,28,rep,name=match_history"`
	xxx_hidden_Resolver      *string                `protobuf:"bytes,30,opt,name=resolver"`
	xxx_hidden_Geo           *string                `protobuf:"bytes,31,opt,name=geo"`
	xxx_hidden_OutboundGeo   *string                `protobuf:"bytes,32,opt,name=outbound_geo"`
	xxx_hidden_Lists         []string               `protobuf:"bytes,33,rep,name=lists"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *Connection) GetGeo() string {
	if x != nil {
		if x.xxx_hidden_Geo != nil {
			return *x.xxx_hidden_Geo
		}
		return ""
	}
	return ""
...
func (x *Connection) GetOutboundGeo() string {
	if x != nil {
		if x.xxx_hidden_OutboundGeo != nil {
			return *x.xxx_hidden_OutboundGeo
		}
		return ""
	}
	return ""
...
func (x *Connection) HasResolver() bool {
	if x == nil {
		return false
	}
...
func (x *Connection) HasOutboundGeo() bool {
	if x == nil {
		return false
	}
...
func (x *Connection) ClearMode() {
	...
	x.xxx_hidden_Mode = config.Mode_bypass
}
...
const file_statistic_config_proto_rawDesc = "" +
	"\n" +
	"\x16statistic/config.proto\x12\x11yuhaiin.statistic\x1a!google/protobuf/go_features.proto\x1a\x13config/bypass.proto\"\x84\x01\n" +
	"\bnet_type\x125\n" +
	"\tconn_type\x18\x01 \x01(\x0e2\x17.yuhaiin.statistic.typeR\tconn_type\x12A\n" +
	"\x0funderlying_type\x18\x02 \x01(\x0e2\x17.yuhaiin.statistic.typeR\x0funderlying_type\"\xb8\a\n" +
	"\n" +
	"connection\x12\x12\n" +
	...
	"\finbound_name\x18\x1b \x01(\tR\finbound_name\x12\x1c\n" +
	"\tinterface\x18\x1d \x01(\tR\tinterface\x12\x1a\n" +
	...
	"\rmatch_history\x18\x1c \x03(\v2&.yuhaiin.statistic.match_history_entryR\rmatch_history\x12\x1a\n" +
	"\bresolver\x18\x1e \x01(\tR\bresolver\x12\x10\n" +
	"\x03geo\x18\x1f \x01(\tR\x03geo\x12\"\n" +
	"\foutbound_geo\x18  \x01(\tR\foutbound_geo\x12\x14\n" +
	"\x05lists\x18! \x03(\tR\x05listsJ\x04\b\x04\x10\x05J\x04\b\x17\x10\x18R\x05extraR\vmode_reason\"F\n" +
...
var file_statistic_config_proto_goTypes = []any{
	...
	(config.Mode)(0),          // 5: yuhaiin.bypass.mode
}
