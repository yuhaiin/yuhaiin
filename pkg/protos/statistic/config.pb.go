...
const file_statistic_config_proto_rawDesc = "" +
	...
	"\x0funderlying_type\x18\x02 \x01(\x0e2\x17.yuhaiin.statistic.typeR\x0funderlying_type\"\xa2\a\n" +
	"\n" +
	"connection\x12\x12\n" +
	...
	"\foutbound_geo\x18  \x01(\tR\foutbound_geoJ\x04\b\x04\x10\x05J\x04\b\x17\x10\x18R\x05extraR\vmode_reason\"F\n" +
