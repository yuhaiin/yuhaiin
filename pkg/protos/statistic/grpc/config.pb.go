...
func file_statistic_grpc_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_statistic_grpc_config_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_statistic_grpc_config_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*AllHistoryList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
