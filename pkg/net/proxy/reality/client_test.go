...
func TestClient(t *testing.T) {
	...
	rlis, err := NewServer(ServerConfig{
		Dest: "223.5.5.5:443",
		ShortID: []string{
			"123456",
		},
		ServerName: []string{"www.xxxxxx.com"},
		PrivateKey: "SHzPN9uMCvhoAz6ZlUFvCyy3rnFmUNv7b26nXTaTtFE",
		Debug:      true,
		// Mldsa65Seed: ptr("fFCePvoqxpzzl2FOVjh4N7XxMQ7M8Opo4Dmn02TrxY8"),
	}, lis)
	assert.NoError(t, err)
	defer rlis.Close()
