...
func TestClient(t *testing.T) {
	...
	rlis, err := NewServer(config.Reality_builder{
		Dest: new("223.5.5.5:443"),
		ShortId: []string{
			"123456",
		},
		ServerName: []string{"www.xxxxxx.com"},
		PrivateKey: new("SHzPN9uMCvhoAz6ZlUFvCyy3rnFmUNv7b26nXTaTtFE"),
		PublicKey:  new("irzN8QFNFHUl4q_KXMTrk4yMLXKEPlM322C2QedY_yU"),
		Debug:      new(true),
