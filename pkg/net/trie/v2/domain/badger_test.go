...
func setupTestDB(t testing.TB) (*DiskTrie[string], string) {
	...
	return NewDiskTrie(dt, codec.UnsafeStringCodec{}), "test.db"
}
...
BenchmarkDiskTrie
BenchmarkDiskTrie/insert
BenchmarkDiskTrie/insert-12         	  117018	     10332 ns/op	    3022 B/op	      58 allocs/op
BenchmarkDiskTrie/search_hit
BenchmarkDiskTrie/search_hit-12     	   47367	     25401 ns/op	   15748 B/op	     275 allocs/op
BenchmarkDiskTrie/search_miss
BenchmarkDiskTrie/search_miss-12    	  402205	      2942 ns/op	    1629 B/op	      39 allocs/op
*/
func BenchmarkDiskTrie(b *testing.B) {
	...
	b.Run("search hit", func(b *testing.B) {
		...
		if err := dt.root.Badger().Close(); err != nil {
			b.Fatal(err)
		}
