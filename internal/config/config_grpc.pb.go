...
func (c *configDaoClient) Load(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Setting, error) {
	out := new(Setting)
	err := c.cc.Invoke(ctx, "/yuhaiin.api.config_dao/load", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *configDaoClient) Save(ctx context.Context, in *Setting, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/yuhaiin.api.config_dao/save", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConfigDao_Load_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yuhaiin.api.config_dao/load",
	}
...
func _ConfigDao_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yuhaiin.api.config_dao/save",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ConfigDao_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yuhaiin.api.config_dao",
